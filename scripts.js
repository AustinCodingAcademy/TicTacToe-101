...
// "this" is a special word in JS but "element" could have been "thing" or "el" or whatever we wanted it to be as long as we use it 
// again in the "console.log" statement

const handleClick = (element) => {

    // let element = parseInt(element.id)
